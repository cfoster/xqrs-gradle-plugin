 ...
 * codecs).
 *
 * Copyright 2019 FasterXML, LLC. All rights reserved.
 *
...
public final class UTF8Writer extends Writer
{
  ...
  {
    this(out, DEFAULT_BUF_LEN, true);
  }

  public UTF8Writer(OutputStream out, int bufferLength, boolean autoclose)
  {
    mAutoCloseOutput = autoclose;
    mOut = out;
    mOutBuffer = new byte[bufferLength];
